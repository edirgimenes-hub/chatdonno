...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  // Striking highlights for primary, soft for secondary
  const variants = {
    primary: "bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600 hover:from-violet-700 hover:via-fuchsia-700 hover:to-pink-700 text-white shadow-lg shadow-fuchsia-500/30 focus:ring-fuchsia-500",
    ...
    icon: "p-2 bg-transparent text-slate-500 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-full"
  };
